---
title: "What is ASA Filament? When to Stop Using PETG for Outdoor Prints"
date: 2026-04-14
description: "ASA filament is the go-to material for outdoor 3D prints. Here's what it is, why it beats PETG outdoors, and what you need to print it successfully."
tags: ["filament", "ASA", "outdoor printing", "materials"]
categories: ["Guides"]
cover:
  image: /posts/what-is-asa-filament/jakub-zerdzicki-INl46kaPG6o-unsplash.jpg
...
**[OVERTURE ASA](https://amzn.to/4mz1Jv9)** — Amazon's Overall Pick, 4.6 stars / 2,100+ reviews, 2K+ bought last month, ±0.02mm accuracy. Prime overnight. Best all-around choice at $19.99/kg.

**[ELEGOO ASA](https://amzn.to/4mz0VGD)** — UV & weather resistant, high impact strength, ±0.02mm accuracy, 600+ bought last month. Best value at $19.99/kg.

**[Polymaker ASA](https://amzn.to/4vAKXjq)** — 4.5 stars / 2,100+ reviews, excellent batch consistency, cardboard spool. Polymaker's quality control is consistently good across their whole lineup. $25.99/kg.

| Pick | Best For | Price |
|---|---|---|
| [OVERTURE ASA](https://amzn.to/4mz1Jv9) | Best overall, highest rated | $19.99/kg |
| [ELEGOO ASA](https://amzn.to/4mz0VGD) | Best value | $19.99/kg |
| [Polymaker ASA](https://amzn.to/4vAKXjq) | Premium consistency | $25.99/kg |
...
Yes — similar to ABS, ASA produces fumes during printing. Print in a ventilated area or with an enclosure that has a HEPA/activated carbon filter. Don't print ASA in a bedroom or living space without ventilation.

**Can I print ASA on a Bambu Lab P1S?**
Yes, the P1S is one of the best printers for ASA. The full enclosure manages chamber temperature well, and Bambu has pre-tuned profiles for ASA that work reliably out of the box.

**How long will ASA last outdoors?**
ASA is rated for multi-year outdoor use. Real-world results vary by UV intensity and climate, but properly printed ASA parts typically last 3–5+ years outdoors without significant degradation.

**Can I use ASA for car parts?**
Yes — ASA's ~95°C heat deflection temperature makes it suitable for most automotive applications that aren't directly on or near the engine. Exterior trim, antenna bases, roof rack accessories, and interior parts that see sun exposure are all good candidates.

**What's the difference between ASA and ABS?**
Both are similar in strength and print settings. The key difference is UV resistance — ABS degrades under prolonged UV exposure, yellowing and becoming brittle. ASA is specifically formulated to resist UV. If the part lives outside, always choose ASA over ABS.

---

## What's Next in the Filament Series

- [PLA vs PETG: Which Should You Use?](/posts/pla-vs-petg/) — start here if you're new to filament
